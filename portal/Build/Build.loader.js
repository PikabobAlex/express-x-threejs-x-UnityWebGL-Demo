function createUnityInstance(t, n, l) {
    ...
    y =
      (document.addEventListener("webkitfullscreenchange", function (e) {
        document.webkitCurrentFullScreenElement === t
          ? t.style.width && ((w = t.style.width), (v = t.style.height), (t.style.width = "100%"), (t.style.height = "100%"))
  ...
  function B(e, t, n, r, o) {
    var a = { url: e, version: g.version, company: t, product: n, updated: r, revalidated: r, accessed: r, response: { headers: {} } };
    return (
      o &&
  ...
  (c.SystemInfo = (function () {
    ...
    var u =
        { "NT 5.0": "2000", "NT 5.1": "XP", "NT 5.2": "Server 2003", "NT 6.0": "Vista", "NT 6.1": "7", "NT 6.2": "8", "NT 6.3": "8.1", "NT 10.0": "10" }[u] ||
        u,
      c =
        ...
        (function o() {
          return void 0 === e
            ? a.arrayBuffer().then(function (e) {
                ...
                return i({ type: "progress", response: a, total: e.length, loaded: 0, lengthComputable: l, chunk: s ? t : null }), t;
              })
            : e.read().then(function (e) {
                ...
                return (
                  ...
                  (f += e.value.length),
                  i({ type: "progress", response: a, total: Math.max(d, f), loaded: f, lengthComputable: l, chunk: s ? e.value : null }),
                  o()
                );
              });
        })().then(function (e) {
          return i({ type: "load", response: a, total: e.length, loaded: e.length, lengthComputable: l, chunk: null }), (a.parsedBody = e), a;
        })
      );
    }),
          ...
          n = {
                ...
                do {
                  if (
                    ...
                    (n = c.inflate(s, b.Z_NO_FLUSH)) === b.Z_NEED_DICT &&
                      d &&
                      ((i = "string" == typeof d ? h.string2buf(d) : "[object ArrayBuffer]" === m.call(d) ? new Uint8Array(d) : d),
                  ...
                  (!s.next_out ||
                    (0 !== s.avail_out && n !== b.Z_STREAM_END && (0 !== s.avail_in || (r !== b.Z_FINISH && r !== b.Z_SYNC_FLUSH))) ||
            ...
            "utils/common.js": function (e, t, n) {
              ...
              (n.setTyped = function (e) {
                e
                  ? ((n.Buf8 = Uint8Array), (n.Buf16 = Uint16Array), (n.Buf32 = Int32Array), n.assign(n, o))
                  ...
                  for (t = new l.Buf8(i), s = o = 0; o < i; s++)
                    55296 == (64512 & (n = e.charCodeAt(s))) &&
                      ...
                      n < 128
                        ...
                        : (n < 2048
                            ? (t[o++] = 192 | (n >>> 6))
                            : (n < 65536 ? (t[o++] = 224 | (n >>> 12)) : ((t[o++] = 240 | (n >>> 18)), (t[o++] = 128 | ((n >>> 12) & 63))),
                              (t[o++] = 128 | ((n >>> 6) & 63))),
                          (t[o++] = 128 | (63 & n)));
                  return t;
                }),
                  ...
                  for (var n, r, o = t || e.length, a = new Array(2 * o), i = 0, s = 0; s < o; )
                    if ((n = e[s++]) < 128) a[i++] = n;
                      ...
                      1 < r
                        ...
                        : n < 65536
                        ? (a[i++] = n)
                        : ((n -= 65536), (a[i++] = 55296 | ((n >> 10) & 1023)), (a[i++] = 56320 | (1023 & n)));
                    }
                  return u(a, i);
                }),
            ...
            "zlib/inflate.js": function (e, t, n) {
              ...
              function l(e, t) {
                var n, r;
                return !e || !e.state || ((r = e.state), t < 0 ? ((n = 0), (t = -t)) : ((n = 1 + (t >> 4)), t < 48 && (t &= 15)), t && (t < 8 || 15 < t))
                  ? N
              ...
              function M(e, t, n, r) {
                var o;
                return (
                  null === (e = e.state).window && ((e.wsize = 1 << e.wbits), (e.wnext = 0), (e.whave = 0), (e.window = new L.Buf8(e.wsize))),
                  r >= e.wsize
                    ? (L.arraySet(e.window, t, n - e.wsize, e.wsize, 0), (e.wnext = 0), (e.whave = e.wsize))
                    : (r < (o = e.wsize - e.wnext) && (o = r),
                      L.arraySet(e.window, t, n - r, o, e.wnext),
                      (r -= o)
                        ? (L.arraySet(e.window, t, n - r, r, 0), (e.wnext = r), (e.whave = e.wsize))
                        : ((e.wnext += o), e.wnext === e.wsize && (e.wnext = 0), e.whave < e.wsize && (e.whave += o))),
                  0
                );
              }
              (n.inflateReset = s),
                ...
                (n.inflate = function (e, t) {
                    ...
                    switch (n.mode) {
                      case z:
                        if (0 === n.wrap) n.mode = 13;
                          ...
                          if (2 & n.wrap && 35615 === d)
                            (B[(n.check = 0)] = 255 & d), (B[1] = (d >>> 8) & 255), (n.check = I(n.check, B, 2, 0)), (u = d = 0), (n.mode = 2);
                          else if (((n.flags = 0), n.head && (n.head.done = !1), !(1 & n.wrap) || (((255 & d) << 8) + (d >> 8)) % 31))
                      ...
                      case 2:
                        ...
                        n.head && (n.head.text = (d >> 8) & 1),
                          512 & n.flags && ((B[0] = 255 & d), (B[1] = (d >>> 8) & 255), (n.check = I(n.check, B, 2, 0))),
                          (u = d = 0),
                          (n.mode = 3);
                      case 3:
                        for (; u < 32; ) {
                        ...
                        n.head && (n.head.time = d),
                          512 & n.flags &&
                            ((B[0] = 255 & d), (B[1] = (d >>> 8) & 255), (B[2] = (d >>> 16) & 255), (B[3] = (d >>> 24) & 255), (n.check = I(n.check, B, 4, 0))),
                          (u = d = 0),
                          (n.mode = 4);
                      case 4:
                        for (; u < 16; ) {
                          ...
                          switch (((n.last = 1 & d), --u, 3 & (d >>>= 1))) {
                            ...
                            case 1:
                              ...
                              if (H) {
                                ...
                                for (P(1, R.lens, 0, 288, Z, 0, R.work, { bits: 9 }), T = 0; T < 32; ) R.lens[T++] = 5;
                                P(2, R.lens, 0, 32, j, 0, R.work, { bits: 5 }), (H = !1);
                              }
                      ...
                      case 19:
                        ...
                        if (((n.lenbits = 9), (S = { bits: n.lenbits }), (_ = P(1, n.lens, 0, n.nlen, n.lencode, 0, n.work, S)), (n.lenbits = S.bits), _)) {
                      ...
                      case 21:
                        ...
                        if (p && 0 == (240 & p)) {
                          for (
                            v = g, y = p, k = w;
                            (p = ((C = n.lencode[k + ((d & ((1 << (v + y)) - 1)) >> v)]) >>> 16) & 255), (w = 65535 & C), !(v + (g = C >>> 24) <= u);
                      ...
                      case 23:
                        ...
                        if (0 == (240 & p)) {
                          for (
                            v = g, y = p, k = w;
                            (p = ((C = n.distcode[k + ((d & ((1 << (v + y)) - 1)) >> v)]) >>> 16) & 255), (w = 65535 & C), !(v + (g = C >>> 24) <= u);
                  ...
                  return (
                    ...
                    (n.hold = d),
                    (n.bits = u),
                    (n.wsize || (f !== e.avail_out && n.mode < 30 && (n.mode < 27 || 4 !== t))) && M(e, e.output, e.next_out, f - e.avail_out)
                      ? ((n.mode = 31), -4)
                      : ((c -= e.avail_in),
                        (f -= e.avail_out),
                        (e.total_in += c),
                ...
                e: do {
                  for (x < 15 && ((k += u[d++] << x), (x += 8), (k += u[d++] << x), (x += 8)), n = _[k & E]; ; ) {
                    if (((k >>>= r = n >>> 24), (x -= r), 0 == (r = (n >>> 16) & 255))) h[f++] = 65535 & n;
                      ...
                      for (
                        o = 65535 & n,
                          (r &= 15) && (x < r && ((k += u[d++] << x), (x += 8)), (o += k & ((1 << r) - 1)), (k >>>= r), (x -= r)),
                        ...
                        if (
                          ((a = 65535 & n),
                          x < (r &= 15) && ((k += u[d++] << x), (x += 8) < r && ((k += u[d++] << x), (x += 8))),
                          g < (a += k & ((1 << r) - 1)))
                        ) {
            ...
            "zlib/inftrees.js": function (e, t, n) {
              ...
              t.exports = function (e, t, n, r, o, a, i, s) {
                ...
                if ((k < x && (x = k), 0 === k)) (o[a++] = 20971520), (o[a++] = 20971520), (s.bits = 1);
                  ...
                  for (y = 1; y < k && 0 === R[y]; y++);
                  for (x < y && (x = y), w = E = 1; w <= 15; w++) if ((E = (E <<= 1) - R[w]) < 0) return -1;
                  if (0 < E && (0 === e || 1 !== k)) return -1;
                  for (L[1] = 0, w = 1; w < 15; w++) L[w + 1] = L[w] + R[w];
                  for (v = 0; v < r; v++) 0 !== t[n + v] && (i[L[t[n + v]]++] = v);
                  if (
                    ((h = 0 === e ? ((U = O = i), 19) : 1 === e ? ((U = P), (T -= 257), (O = D), (I -= 257), 256) : ((U = N), (O = z), -1)),
                    (w = y),
                    (f = a),
                    (S = v = B = 0),
                    (u = -1),
                  ...
                  for (;;) {
                    for (
                      g = i[v] < h ? ((m = 0), i[v]) : i[v] > h ? ((m = O[I + i[v]]), U[T + i[v]]) : ((m = 96), 0), l = 1 << (b = w - S), y = d = 1 << _;
                      (o[f + (B >> S) + (d -= l)] = (b << 24) | (m << 16) | g | 0), 0 !== d;
